...
เรามีแนวโน้มที่จะพิจารณาคำแนะนำเพื่อดูแลจัดการหัวข้อหรือคอลเล็กชันที่มีคุณค่าต่อชุมชนของ GitHub ตัวอย่างเช่นหัวข้อที่มีคุณค่ารวมถึงหัวข้อที่[ที่เก็บใช้กันอย่างแพร่หลาย] (https://help.github.com/articles/classifying-your-repository-with-topics/)และอาจได้รับประโยชน์จากการเพิ่มข้อมูลสำคัญ . เมื่อแนะนำเนื้อหาโปรดพิจารณาวิธีทำให้การมีส่วนร่วมของคุณมีประโยชน์ในวงกว้างและเกี่ยวข้องกับผู้อื่นแทนที่จะให้บริการเฉพาะกรณีการใช้งาน
